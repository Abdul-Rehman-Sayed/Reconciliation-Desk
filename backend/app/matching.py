...
AMOUNT_EXACT_TOLERANCE = 1.00
AMOUNT_TOLERANT_BAND = 0.004
FEE_MATCH_TOLERANCE = 2.00
FEE_RATE_MIN = 0.005
FEE_RATE_MAX = 0.035
KNOWN_FEE_RATES = (0.0118, 0.0236, 0.0295)


DATE_WINDOW_EXACT = 2
DATE_WINDOW_TOLERANT = 5
DATE_WINDOW_REFUND = 4
DUPLICATE_DATE_WINDOW = 1
DATE_WINDOW_COMPOSITE = 4
DATE_WINDOW_FUZZY = 6
...
REF_FUZZY_AUTO = 90.0
REF_FUZZY_CANDIDATE = 62.0


COMPOSITE_MAX_GROUP = 4
COMPOSITE_TOLERANCE = 2.00
COMPOSITE_PARTY_PREFIX = 10
COMPOSITE_FALLBACK_POOL = 14
...
CONF_REFUND = 0.90
CONF_DUPLICATE = 0.95
CONF_COMPOSITE_CEIL = 0.75
CONF_FUZZY_CEIL = 0.70
CONF_UNRESOLVED = 0.15


CONF_TOLERANT_FLOOR = 0.85
AUTO_RESOLVE_FLOOR = 0.85
        ...
        for l in free_l:
            self.exceptions.append(
                Exception_(
                    ...
                    engine_note=(
                        "The ledger records %.2f from %s on %s with status '%s', and six "
...
def summarise(engine: Engine) -> dict[str, Any]:
    ...
    return {
        ...
        "match_rate_with_proposed": round(len(resolved_ids) / total, 4) if total else 0.0,
